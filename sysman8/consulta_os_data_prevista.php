...
//-----------------------------------------------------------------------------------------------//
$sql = "SELECT * FROM tbOs WHERE dataPrevistaOs >='$dataPrevistaOs' AND dataPrevistaOs <='$dataConclusaoOs'AND situacao='$situcaoOs'
...
if ($cont > 0) {
    ...
    //<th>Data emissao</th>
    $tabela = "<table id='minhaTabela' border='0' border-style='hidden'>
                <thead>
                    <tr>
                        <th>Código O.S</th>
