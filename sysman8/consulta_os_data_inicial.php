...
$executante .= "%";
$sql = "SELECT * FROM tbOs WHERE dataPrevistaOs >='$dataPrevistaOs' AND situacao='$situcaoOs'ORDER BY dataPrevistaOs ASC";
//}
sleep(1);
...
if ($cont > 0) {
    ...
    while ($linha = mysqli_fetch_array($result)) {
        ...
        $return .= "<td>" . utf8_encode($linha["dataEmissaoOs"]) . "</td>";
        $return .= "<td>" . utf8_encode($linha["horaEmissaoOs"]) . "</td>";
        ...
        $return .= "<td>" . utf8_encode($linha["situacao"]) . "</td>";
         $return .= "<td>" . "<input type='checkbox' id='btEditar' name='btEditar' value='Editar'>" . "</td>";
